...
namespace ToDo.EntityFrameworkCore.Frameworks.Base
{
    public class BaseService<D_DbContext, E_Entity, P_PrimaryKey> : Domain.Contract.Repository.IRepository<E_Entity, P_PrimaryKey>
